let apis = {
  bounding: {
    api:'https://api.openhistoricalmap.org/api/0.6/map?bbox=',
    url: (left, bottom, right, top) => {
      return apis.bounding.api + left + ',' + bottom + ',' + right + ',' + top;
    },
  },
  getRelation: {
    api:'https://api.openhistoricalmap.org/api/0.6/relation/',
    parameters:'/full',
    url: (relationId) => {
  ...
  getWay: {
    api:'https://api.openhistoricalmap.org/api/0.6/way/',
    parameters:'/full',
    url: (wayId) => {
